...
class Update_Staff implements ActionListener {
    ...
    Update_Staff(String staffid) {
        ...
        try {
            conn con = new conn();
            String str = "select staff.*,jobtitle.jobid,jobtitle.jobrole,jobtitle.deptid from staff right join jobtitle on staff.staffid=jobtitle.staffid where staff.staffid='" + staffid + "';";
