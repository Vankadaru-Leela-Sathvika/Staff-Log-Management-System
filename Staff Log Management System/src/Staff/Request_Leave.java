...
public class Request_Leave implements ActionListener {
    ...
    Request_Leave(String staffid) {
        this.staffid = staffid;
        f = new JFrame("Request Leave");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b) {
            try {
                conn cc = new conn();
                String q = "insert into staffleave(staffid,name,jobid,date,reason,status) values('" + a + "','" + bb + "','" + c + "','" + d + "','" + e + "','pending')";
